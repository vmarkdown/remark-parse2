export declare type TTokenTypeBlock = 'root' | 'newline' | 'code' | 'math' | 'thematicBreak' | 'heading' | 'blockquote' | 'list' | 'listItem' | 'html' | 'table' | 'tableRow' | 'tableCell' | 'definition' | 'footnoteDefinition' | 'paragraph';
export declare type TTokenTypeInline = 'inlineCode' | 'strong' | 'emphasis' | 'delete' | 'inlineMath' | 'footnoteReference' | 'linkReference' | 'imageReference' | 'inlineLink' | 'sup' | 'sub' | 'mark' | 'handle' | 'underline' | 'break' | 'icon' | 'link' | 'image' | 'whitespace' | 'text';
export declare type TTokenType = 'root' | TTokenTypeBlock | TTokenTypeInline;
...
export declare type TBlockToken = INewline | ICode | IMath | IThematicBreak | IHeading | IBlockquote | IList | IListItem | IHtml | ITable | ITableRow | ITableCell | IDefinition | IFootnoteDefinition | IParagraph;
export declare type TInlineToken = IInlineCode | IStrong | IEmphasis | IDelete | IInlineMath | IFootnoteReference | ILinkReference | IImageReference | ILink | IImage | IInlineLink | ISup | ISub | IMark | IHandle | IUnderline | IBreak | IIcon | IText | IWhitespace;
export declare type TAnyToken = TBlockToken | TInlineToken;
export declare type TNullableToken<T extends TAnyToken> = T | undefined | null;
export declare type TChildrenToken<T extends TAnyToken> = TNullableToken<T> | T[];
export declare type TChildrenBlock = TChildrenToken<TBlockToken>;
export declare type TChildrenInline = TChildrenToken<TInlineToken>;
export declare type TEat<T extends TAnyToken> = (subvalue: string, type: TTokenType, children?: TNullableToken<any>, overrides?: Partial<TAnyToken>) => T;
export declare type TTokenizer<T extends TAnyToken> = (this: IParser, eat: TEat<T>, value: string) => TNullableToken<T>;
